<template>
  ...
  >
    <ComboboxInput
      class="h-[3.5rem] w-full rounded-md outline-none border border-transparent focus:border-[var(--primary)] px-4 placeholder:font-semibold placeholder:text-sm placeholder:text-gray-500 font-black text-sm"
