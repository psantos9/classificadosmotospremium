<template>
  <div class="w-full flex justify-center items-center z-10">
    <div class="relative z-10 grid grid-cols-6 gap-4 md:gap-8 w-full md:max-w-screen-md items-center justify-center md:rounded-xl bg-black py-8 px-4 md:px-8 shadow border-2 border-white">
