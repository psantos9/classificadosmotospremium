...
export default defineConfig(({ mode }) => {
  ...
  const config: UserConfig = {
    ...
    define: {
      __API_BASE_URL: JSON.stringify(mode === 'production' ? 'https://backend.classificadosmotospremium.com.br' : mode === 'preview' ? 'https://backend.preview.classificadosmotospremium.com.br' : 'http://localhost:8088'),
