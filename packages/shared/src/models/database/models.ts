...
export type PublicAd = Omit<Anuncio, 'userId' | 'atualizacao' | 'reviewWorkflowId' | 'expiresAt' | 'publishedAd' | 'revision'> & { cor: Cor, usuario: { nomeRazaoSocial: string, nomeFantasia: string | null } }
