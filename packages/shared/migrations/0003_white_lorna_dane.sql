...
INSERT INTO `__new_mensagem`("id", "created_at", "unread", "thread_id", "recipient_id", "ad_id", "sender_id", "unauthenticated_sender", "content") SELECT "id", "created_at", "unread", "thread_id", "recipient_id", "ad_id", "sender_id", "unauthenticated_sender", "content" FROM `mensagem`;--> statement-breakpoint
